...
namespace BookStoresWebAPI.Models
{
    public partial class BookStoresDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Name=DBConnect");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .HasConstraintName("FK__Book__pub_id__2A4B4B5E");
            });
            ...
            modelBuilder.Entity<BookAuthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    ...
                    .HasConstraintName("FK__BookAutho__book___2C3393D0");
            });
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F2226B74671B");
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__RefreshTo__user___2D27B809");
            });
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    .WithMany(p => p.Sale)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__Sale__book_id__2E1BDC42");

                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Sale)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK__Sale__store_id__2F10007B");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    .WithMany(p => p.User)
                    .HasForeignKey(d => d.PubId)
                    .HasConstraintName("FK__User__pub_id__30F848ED");
